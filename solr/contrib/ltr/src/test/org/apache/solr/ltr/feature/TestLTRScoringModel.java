...
public class TestLTRScoringModel extends TestRerankBase {
  ...
  public void getInstanceTest() {
    ...
    final LTRScoringModel meta = TestLTRScoringModel.createRankSVMModel("test1",
  ...
  public void nullFeatureWeightsTest() {
    ...
    try {
      ...
      final List<Normalizer> norms = 
        new ArrayList<Normalizer>(
            Collections.nCopies(features.size(),IdentityNormalizer.INSTANCE));
      final LTRScoringModel meta = TestLTRScoringModel.createRankSVMModel("test2",
  ...
  public void existingNameTest() {
    ...
    try {
      ...
      Map<String,Object> params = new HashMap<String,Object>();
      params.put("weights", weights);
      final LTRScoringModel meta = TestLTRScoringModel.createRankSVMModel("test3",
          features, norms, "test", fstore.getFeatures(),
              params);
      store.addModel(meta);
  ...
  public void duplicateFeatureTest() {
    ...
    try {
      ...
      Map<String,Object> params = new HashMap<String,Object>();
      params.put("weights", weights);
      final LTRScoringModel meta = TestLTRScoringModel.createRankSVMModel("test4",
          features, norms, "test", fstore.getFeatures(),
              params);
      store.addModel(meta);
      fail("unexpectedly got here instead of catching "+expectedException);
  ...
  public void missingFeatureWeightTest() {
    ...
    try {
      ...
      Map<String,Object> params = new HashMap<String,Object>();
      params.put("weights", weights);
      final LTRScoringModel meta = TestLTRScoringModel.createRankSVMModel("test5",
          features, norms, "test", fstore.getFeatures(),
              params);
      fail("unexpectedly got here instead of catching "+expectedException);
    } catch (ModelException actualException) {
  ...
  public void emptyFeaturesTest() {
    ...
    try {
      ...
      Map<String,Object> params = new HashMap<String,Object>();
      params.put("weights", weights);
      final LTRScoringModel meta = TestLTRScoringModel.createRankSVMModel("test6",
          features, norms, "test", fstore.getFeatures(),
          params);
      store.addModel(meta);
      fail("unexpectedly got here instead of catching "+expectedException);
